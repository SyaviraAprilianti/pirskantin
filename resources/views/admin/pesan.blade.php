...
<body id="page-top">
  ...
  <div id="wrapper">
      ...
      <div id="content">
       ...
       @include('admin.topbar')
        ...
        <div class="container-fluid">
              ...
              <!-- Content Row -->
              <form method="post" action="/pesan/makan">
    ...
    @endif
        <div class="form-group">
            <input type="hidden" name="nama_makanan" value="{{$makanan->nama_makanan}}"> 
        </div>
    ...
    @endif
        <div class="form-group">
            <input type="text" name="nama_pemesan" placeholder="Pemesan"> 
        </div>  
